...
<div class="w-full bg-white h-[96px] drop-shadow-lg flex flex-row items-center">
        <div class="w-1/3 pl-5">
                <a href="" class="uppercase text-base mx-5 text-black font-inter hover:text-develobe-500 duration-200 font-bold">Movies</a>

                <a href="" class="uppercase text-base mx-5 text-black font-inter hover:text-develobe-500 duration-200 font-bold">TV Show</a>
            </div>
